...
exports.DestinationModule = DestinationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [destination_service_1.DestinationService, destination_repository_1.DestinationRepository],
        exports: [destination_service_1.DestinationService, destination_repository_1.DestinationRepository],
    })
], DestinationModule);
